...
function cryptoPlugin(pluginObject, noAutoRefresh) {
    ...
    this.errorDescription[this.errorCodes.X509V3_INVALID_OBJECT_IDENTIFIER] = "Неверный или некорректный идентификатор объекта";
    ...
    this.errorDescription[this.errorCodes.BF_NOT_FOUND] = "Бинарный файл не найден на устройстве";
    this.errorDescription[this.errorCodes.BF_CANNOT_REMOVE] = "Бинарный файл не удалось удалить с устройства";
        ...
        this.runTest = function () {
            ...
            plugin.pluginObject.getDeviceInfo(ui.device(), info).then(function (result) {
                ...
                case plugin.TOKEN_INFO_SUPPORTED_MECHANISMS:
                    ...
                    ciphers[plugin.CIPHER_ALGORITHM_KUZNECHIK_CTRACPKM] = "CIPHER_ALGORITHM_KUZNECHIK_CTRACPKM";
                    ciphers[plugin.CIPHER_ALGORITHM_KUZNECHIK_ACPKM_OMAC] = "CIPHER_ALGORITHM_KUZNECHIK_ACPKM_OMAC";
